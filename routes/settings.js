...
async function respondSettings(req, res, error, success) {
...
app.get('/settings', requireSession, csrfProtection, async (req, res) => {
    const user = db.prepare('SELECT id, username FROM users WHERE id = ?').get(req.session.userId);
...
app.post('/settings/password', requireSession, csrfProtection, async (req, res) => {
...
app.post('/settings/theme', requireSession, csrfProtection, async (req, res) => {
...
app.post('/settings/regen-key', requireSession, csrfProtection, async (req, res) => {
...
app.post('/settings/dateformat', requireSession, csrfProtection, async (req, res) => {
...
app.post('/settings/upload-limit', requireAdmin, csrfProtection, async (req, res) => {
...
app.post('/settings/local-url', requireAdmin, csrfProtection, async (req, res) => {
...
app.get('/web/upload-status', requireSession, async (req, res) => {
    res.json({ active: dbLib.activeUploads.size, lastUploadAt: dbLib.lastUploadAt });
});

app.post('/web/folders/remove', requireSession, csrfProtection, async (req, res) => {
